 ...
 */
@Component
public class RocketMqConsumeDemo {
    ...
    public class ConsumerSend implements RocketMQListener<JwtInfo> {
        // 监听到消息就会执行此方法
        @Override
        public void onMessage(JwtInfo jwtInfo) {
            logger.info("tag1-监听到消息：jwtInfo={}", JSON.toJSONString(jwtInfo));
        }
    }
    ...
    public class Consumer implements RocketMQListener<MessageExt> {
        ...
        public void onMessage(MessageExt messageExt) {
            ...
            logger.info("tag2-监听到消息：msg={}", msg);
        }
    }
